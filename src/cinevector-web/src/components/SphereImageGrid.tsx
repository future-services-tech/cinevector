 ...
 * il click su un'immagine al chiamante (che decide cosa mostrare — dettaglio, card, ecc.). */
export function SphereImageGrid({ images, onSelect, ...overrides }: SphereImageGridProps) {
  ...
  function handlePointerDown(e: ReactPointerEvent<HTMLDivElement>) {
    ...
    // di raggiungere il poster sotto il cursore (verificato: un tap reale non apriva più la card) — senza
    // capture il drag funziona lo stesso finché il puntatore resta sopra il contenitore.
  }
        ...
        return (
          <div
            ...
            style={{
              ...
              boxShadow: isHovered ? "0 0 22px var(--glow-primary)" : "0 4px 14px rgba(0,0,0,0.45)",
